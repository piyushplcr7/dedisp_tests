...
void getDataFromRows(FILE *fptr, unsigned char *table_data, long rows) {
  // read data
  fread(table_data, 1, bytes_per_row * rows, fptr);
}
...
int main(int argc, char **argv) {
  ...
  */
  ...
  long bytes_to_be_read = bytes_per_row * rows;
  ...
  getDataFromRows(fptr, table_full, rows);
